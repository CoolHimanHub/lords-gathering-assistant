...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply { text = "LM Companion  •  V0.9.6"; textSize = 20f; setTextColor(Color.WHITE); setPadding(0,0,0,12) })
    ...
    private fun readinessText(): String {
        ...
        return buildString {
            ...
            append("\nRuntime: V0.9.6 sustained capture-session diagnostics active")
        }
    }
