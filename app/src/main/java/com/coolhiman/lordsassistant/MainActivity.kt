...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply { text = "LM Companion  •  V2.3.1"; textSize = 20f; setTextColor(Color.WHITE); setPadding(0,0,0,12) })
    ...
    private fun readinessText(): String {
        ...
        return buildString {
            ...
            append("\nRuntime: V2.3.1 — discovery, grid learning, calibration and guarded actions")
        }
    }
