...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        root.addView(TextView(this).apply { text = "LM Companion  •  V0.8.8"; textSize = 20f; setTextColor(Color.WHITE); setPadding(0,0,0,12) })
    ...
    private fun readinessText(): String {
        ...
        return buildString {
            ...
            append("\nRuntime: V0.8.8 candidate-rejection diagnostics active")
        }
    }
