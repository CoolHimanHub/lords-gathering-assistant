...
class GatheringAccessibilityService :
    ...
    private fun detectBlueBadges(
         ...
         * V11 DETECTION MODEL
         *
         * The previous detector searched for blue connected components.
         * That is unreliable in Lords Mobile because RSS artwork itself
         * contains blue/purple pixels and can touch the level badge.
         *
         * V11 uses the stable visual feature visible in the supplied
         * screenshots:
         *
         *          WHITE LEVEL DIGIT
         *                  +
         *          BLUE BADGE AROUND IT
         *
         * The white digit is detected first. Its surrounding blue area
         * is then validated as an RSS badge.
         */
        ...
        /*
         * Screen-pixel map viewport for the supplied 1536x707 layout.
         *
         * Top HUD:        y < 70
         * Bottom HUD:     y >= 590
         * Left HUD:       x < 110
         * Right HUD:      x >= 1285
         *
         * The assistant overlay is additionally excluded dynamically.
         */
        val mapLeft =
            min(
                width,
        ...
        fun isBadgeBluePixel(
            ...
            /*
             * Broad enough for the anti-aliased badge edges visible in
        ...
        fun insideAssistantOverlay(
            ...
            /*
             * Layout width is 470 px. A small margin prevents the
             * assistant's rounded/shadowed edge from becoming a badge.
             */
            val right =
                left + 490
        ...
        /*
         * Find compact near-white components. The level digit in the
         * supplied screenshots is a narrow vertical component.
         */
        for (
            gy in 0 until gridHeight
        ) {

            for (
                gx in 0 until gridWidth
            ) {
                ...
                /*
                 * Reject ordinary map/UI highlights and text.
                 */
                if (
                    pixels !in 8..120 ||
                    boxWidth !in 2..15 ||
                ...
                /*
                 * Validate the blue badge surrounding the white digit.
                 */
                val blueLeft =
                    max(
                        mapLeft,
                ...
                /*
                 * Real badges in the supplied screenshots have a strong
                 * blue field surrounding the white level digit.
                 */
                if (
                    bluePixels < 80 ||
                    blueFraction < 0.20f
                 ...
                 * Critical V11 fix:
                 *
                 * Do NOT use the entire connected blue component as the
                 * badge. It can include the blue/purple RSS artwork.
                 *
                 * Instead create a stable local badge box around the
                 * detected white digit.
                 */
                digitComponents.add(
                    BlueComponent(
                        minX =
        ...
        /*
         * Keep one candidate per physical badge. Multiple white
         * fragments can otherwise describe the same badge.
         */
        val result =
            mutableListOf<BlueComponent>()

        for (
            candidate in digitComponents
        ) {
