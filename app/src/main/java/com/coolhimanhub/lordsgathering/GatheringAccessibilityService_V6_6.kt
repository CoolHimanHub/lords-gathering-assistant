...
class GatheringAccessibilityService :
    ...
    private fun normalizeLevelText(
        ...
        /*
         * Exact one-character interpretation first.
         */
        if (
            cleaned.length == 1 &&
            cleaned[0].isDigit()
    ...
    private fun findLevelForBadge(
         ...
         * IMPORTANT V6.6 FIX:
         *
         * Never associate a nearby OCR digit with a resource badge.
         * The previous version could read unrelated numbers from
         * monsters/UI and turn a real Lv2/Lv3 resource into Lv5.
         *
         * The level must come from the blue RSS badge itself.
         */
        val direct = readLevelFromBadgeFallback(
            bitmap,
            badge
        )
        ...
        // Deliberately do NOT fall back to whole-screen OCR.
        return 0
    }

    // =============================================================
    // INDIVIDUAL BADGE OCR FALLBACK
    // =============================================================
