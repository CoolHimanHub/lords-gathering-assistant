...
class GatheringAccessibilityService :
    ...
    private fun findLevelForBadge(
        ...
        /*
         * OCR should be physically close to the badge.
         */
        val nearby =
            ocrDigits
                .filter {
        ...
        /*
         * Fallback: OCR the individual badge at high scale.
         */
